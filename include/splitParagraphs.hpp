...
inline std::vector<std::string> splitVectorByChar(const std::vector<std::string>& array, char delimiter) {
  std::vector<std::string> lines;
  std::string line;
...
inline std::vector<std::string> convertStringToParagraph(const std::string& text, std::size_t length) {
  std::vector<std::string> lines;
